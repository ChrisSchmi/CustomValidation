...
namespace CustomValidation
{
    ...
    public class CustomRange : RangeAttribute 
    {
        ...
        {
            //return String.Format(CultureInfo.CurrentCulture, $"range({this.Minimum},{this.Maximum})", name, this.Minimum, this.Maximum);
            return String.Format(CultureInfo.CurrentCulture, $"range", name, this.Minimum, this.Maximum);
        }
    }
    ...
    public class CustomRange : ValidationAttribute
    {
        ...
        /// <param name="minimum">The minimum value, inclusive</param>
        /// <param name="maximum">The maximum value, inclusive</param>
        public CustomRange(double minimum, double maximum)
            : this()
        {
            this.Minimum = minimum;
            this.Maximum = maximum;
        ...
        public CustomRange(Type type, string minimum, string maximum)
            : this()
        {
        ...
        private void Initialize(IComparable minimum, IComparable maximum, Func<object, object> conversion)
        {
            ...
            {
                throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, "min greater than max", maximum, minimum));
            }
        ...
        private void SetupConversion()
        {
            if (this.Conversion == null)
            {
                ...
                {
                    throw new InvalidOperationException("min and max must be set");
                }
                ...
                else
                {
                    ...
                    if (type == null)
                    {
                        throw new InvalidOperationException("operand type must be set");
                    }
